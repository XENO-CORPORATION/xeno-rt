...
Status: Draft implementation spec, Phase 8 dense Qwen2, AutoAWQ GEMM4, and GPTQ v1 GEMM4 CUDA validated; compressed formats pending
Date: 2026-06-19
...
- Explicitly pending: compressed-tensors, GPTQ v2/act-order variants, other AWQ packing/execution versions, EXL3 evaluation, SafeTensors CPU decode, and architecture support beyond Qwen2.
