...
Status: Draft implementation spec, Phase 8 dense Qwen2, AutoAWQ GEMM4, GPTQ v1 GEMM4, and compressed-tensors W4A16 CUDA validated
Date: 2026-06-19
...
- Explicitly pending: GPTQ v2/act-order variants, other AWQ packing/execution versions, EXL3 evaluation, SafeTensors CPU decode, and architecture support beyond Qwen2.
