...
Status: Draft implementation spec, Phase 8 dense Qwen2, AutoAWQ GEMM4, GPTQ v1/v2 and act-order GEMM4, and compressed-tensors W4A16 CUDA validated
Date: 2026-06-19
...
- Explicitly pending: other AWQ packing/execution versions, EXL3 evaluation, SafeTensors CPU decode, architecture support beyond Qwen2, and broader independent GPTQ v2 checkpoint coverage beyond the derived semantic fixture.
