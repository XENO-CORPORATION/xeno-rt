...
- Complete and RTX 4090 validated for the first target: standard dense batch-1 decode with contiguous or runtime-shared F32 paged KV and resident F32/F16/BF16/Q8_0/Q4_0/Q4_K/Q5_K/Q6_K weight layouts.
...
- Gemma4 variable-width layers, shared Q8/KQ4/adaptive KV graph capture, shared-F32 concurrent parent-graph composition, and graph batch sizes above one remain eager CUDA extensions; they do not block the validated Phase 5 batch-1 standard-dense target.
...
- Extend the validated batch-1 shared-F32 whole-decode graph path to shared Q8, KQ4/VQ8, and adaptive caches, then admit shared-F32 sessions into concurrent parent-graph composition with equivalent ownership and stale-replay checks.
